...
export default function Home() {
  const services = [
    {
      ...
      items: [
        "VM provisioning, optimization, and patching",
        "Network management (VNETs, VPNs, ExpressRoute)",
        "Load balancing, traffic optimization & firewall management",
    ...
    },
    {
      ...
      items: [
        ...
        "Threat detection & security monitoring (Sentinel, Defender for Cloud)",
        "Regulatory compliance (GDPR, HIPAA, ISO, etc.)",
        "Encryption, DLP, and Zero Trust security implementation",
      ],
    },
    {
      ...
      items: [
        "Cost monitoring and rightsizing analysis",
        "Auto-scaling configurations and performance tuning",
        "Reserved Instances & Savings Plan management",
      ],
    },
    {
    ...
    {
      title: "Azure Data & Analytics Management",
      icon: "/images/Microsoft_13.png",
      items: [
        "Database administration (SQL, CosmosDB, MySQL, PostgreSQL)",
        "Data pipeline automation (Data Factory, Synapse)",
        "Big Data & AI/ML workload management",
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-400 ">
      <Head>
        <title>Azure Managed Services</title>
          ...
          <div className="flex flex-col md:flex-row">
            ...
            >
              ...
              <p className="text-xl sm:mb-6 md:mt-8 text-white font-bold md:ml-28 ">
                As a trusted Microsoft Azure Partner, we provide comprehensive
                Azure Managed Services to help businesses optimize costs,
                improve security, and ensure high availability of their cloud
                environments. Our certified Azure experts handle the
                complexities of cloud management, allowing you to focus on
        ...
        <div className="">
          <div className=" pb-24 pt-20 ">
            ...
            <p className="text-lg ml-4 text-gray-600 mb-12 max-w-2xl">
              Our certified Azure experts handle the complexities
              <br />
              of cloud management, allowing you to focus on
              <br />
              innovation and growth.
            </p>
