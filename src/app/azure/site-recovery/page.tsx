  ...
  const services = [
    {
      ...
      items: [
        "Assess existing infrastructure and define recovery objectives ",
        "Develop a tailored disaster recovery strategy using Azure Site Recovery ",
        "Identify critical applications and dependencies for failover planning ",
      ],
    },
    {
      title: "Azure Site Recovery Implementation ",
      icon: "/images/Microsoft_11.png",
      items: [
        "Configure ASR for automated replication and failover ",
        "Optimize recovery point objectives (RPO) and recovery time objectives (RTO) ",
        "Integrate with on-premises, hybrid, and multi-cloud environments ",
      ],
    },
    {
      ...
      items: [
        "Conduct non-disruptive failover testing ",
        "Validate recovery processes and application integrity ",
    ...
    },
    {
      ...
      items: [
        "Implement Azure Monitor, Log Analytics, and Security Center for proactive management ",
        "Optimize cost and performance with workload-specific tuning ",
        "Provide 24/7 support and ongoing compliance assessments ",
      ],
    },
  ];
        ...
        <div className=" rounded-lg overflow-hidden mb-12">
          <div className="flex flex-col md:flex-row">
            <div className="w-full  h-2/5 md:w-1/2 p-8  md:p-12 flex flex-col justify-center relative">
              <h1 className="absolute top-16 left-2/3 transform -translate-x-1/2 -translate-y-1/2 text-4xl  text-gray-700 font-semibold bg-opacity-70 scroll w-full pl-  py-2  rounded-md">
                Azure Site Recovery
              </h1>
            ...
            >
              ...
              <p className="text-xl sm:mb-6 md:mt-8 text-white font-bold md:ml-28 ">
                We ensure business continuity with our expert Azure Site
                Recovery Service. As an Azure Partner, we help enterprises
                implement a robust disaster recovery strategy by leveraging
                Azure Site Recovery (ASR). Our comprehensive approach ensures
                minimal downtime, data integrity, and seamless failover and
                failback operations.
              </p>
        ...
        <div className="">
          <div className=" pb-24 pt-20 ">
            ...
            <ul className="list-disc ml-3 pb-6 list-inside mt-4 space-y-2">
              <li>
                Minimize downtime and data loss with automated disaster recovery{" "}
              </li>
              <li>
                Reduce costs with an efficient cloud-based recovery solution{" "}
              </li>
              <li>
                Ensure compliance with industry regulations and security
                standards{" "}
              </li>
              <li>
                Seamlessly replicate workloads across on-premises and Azure
                environments{" "}
              </li>
              <li>
                Continuous monitoring, testing, and optimization for maximum
                resilience{" "}
              </li>
            </ul>
