...
export default function Home() {
  const services = [
    {
      title: "Kubernetes Readiness Assessment & Strategy ",
      icon: "/images/Microsoft_9.png",
      items: [
        "Evaluate existing containerized workloads and dependencies ",
        "Define migration strategy and roadmap to Azure Kubernetes Service ",
        "Assess cost implications and performance optimization ",
      ],
    },
    {
      title: "Azure Kubernetes Architecture Design",
      icon: "/images/Microsoft_11.png",
      items: [
        "Design scalable and secure AKS clusters ",
        "Implement networking, storage, and identity management best practices ",
        "Ensure compliance and governance with Azure policies ",
      ],
    },
    {
      ...
      items: [
        "Lift-and-shift or re-architect applications for AKS ",
        "Deploy and configure AKS clusters with automation ",
    ...
    },
    {
      ...
      items: [
        "Enable auto-scaling and load balancing for cost efficiency ",
        "Implement logging, monitoring, and performance tuning ",
        "Optimize storage and networking for high availability ",
      ],
    },
    {
      ...
      items: [
        "Use Azure Monitor, Application Insights, and Log Analytics for observability ",
        "Proactive issue resolution and ongoing support ",
        "Continuous cost optimization and performance improvements ",
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-400 ">
      <Head>
        <title>Azure Kubernetes Service (AKS) Migration </title>
        ...
        <div className=" rounded-lg overflow-hidden mb-12">
          <div className="flex flex-col md:flex-row">
            <div className="w-full  h-2/5 md:w-1/2 p-8  md:p-12 flex flex-col justify-center relative">
              {/* <h1 className="absolute top-16 left-2/4 transform -translate-x-1/2 -translate-y-1/2 text-4xl  text-gray-700 font-semibold bg-opacity-70 scroll w-full pl-  py-2  rounded-md">
            ...
            >
              ...
              <p className="text-xl sm:mb-6 md:mt-8 text-white font-bold md:ml-28 ">
                Migrate your containerized applications to Azure Kubernetes
                Service (AKS) with confidence. Our Azure Kubernetes Migration
                Service helps enterprises transition their workloads to AKS
                while ensuring scalability, security, and cost efficiency. As an
                Azure Partner, we deliver a seamless migration experience
        ...
        <div className="">
          <div className=" pb-24 pt-20 ">
            ...
            <ul className="list-disc ml-3 pb-6 list-inside mt-4 space-y-2">
              <li>Accelerate Kubernetes migration with minimal disruption</li>
              <li>Optimize performance and cost with Azure-native tools</li>
              <li>Enhance security and compliance with best practices</li>
              <li>Enable high availability and auto-scaling capabilities</li>
              <li>Provide continuous monitoring, management, and support</li>
            </ul>
