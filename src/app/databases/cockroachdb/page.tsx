...
export default function Home() {
  ...
  const heroContent: HeroContentType = {
    ...
    subtitle: "Database",
    description:
      "Our Services provide businesses with highly available, scalable, and resilient distributed SQL database solutions. As an open-source software support provider, we specialize in deploying, optimizing, securing, and managing CockroachDB across on-premises, cloud, and hybrid environments to support globally distributed, high-performance workloads.",
    buttons: [
      {
        text: "Talk to Expert",
    ...
    cards: [
      {
        ...
        title: "Distributed SQL with High Availability",
        description:
          "Resilient, self-healing database for mission-critical applications.",
      },
      {
        icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
        title: "Cloud-Native & Multi-Cloud Deployments",
        description:
          "Deploy CockroachDB on AWS, Azure, GCP, Kubernetes, OpenShift, and on-prem.",
      },
      {
        icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10",
        title: "Geo-Distributed Architecture",
        description:
          "Enable low-latency, globally consistent transactions across multiple regions.",
      },
      {
        icon: "M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01",
        title: "Automated Scalability & Fault Tolerance",
        description: "Seamless scaling with built-in replication and failover.",
      },
      {
        icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",
        title: "Advanced Security & Compliance",
        description:
          "Implement encryption, role-based access control (RBAC), and audit logging.",
      },
      {
        icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
        title: "24/7 Enterprise Support & Monitoring",
        description:
          "Proactive database health monitoring, troubleshooting, and performance optimization.",
      },
    ],
  };
    ...
    services: [
      {
        ...
        title: "CockroachDB Deployment & Configuration",
        textColor: "text-blue-500",
        items: [
          "Custom CockroachDB Cluster Setup – Deploy CockroachDB for OLTP, real-time analytics, and cloud-native applications.",
          "Cloud-Native & Kubernetes-Based CockroachDB – Optimize for containers, serverless, and multi-cloud environments.",
          "Multi-Cloud & Hybrid Deployments – Implement CockroachDB on AWS, Azure, GCP, and private data centers.",
        ],
      },
      {
        ...
        items: [
          "Multi-Region Deployment for Global Availability – Reduce latency with geo-replication and multi-active architecture.",
          "Automated Failover & Self-Healing Clusters – Ensure zero downtime with Raft-based consensus and replication.",
          "Continuous Backups & Point-in-Time Recovery (PITR) – Implement automated snapshots and fast recovery mechanisms.",
        ],
      },
      {
        ...
        textColor: "text-blue-500",
        items: [
          "Indexing & Partitioning for Distributed SQL – Optimize query performance with automated table partitioning.",
          "Workload-Aware Query Optimization – Tune SQL execution plans for high-performance transaction processing.",
          "Load Balancing & Connection Pooling – Improve efficiency with CockroachDB's distributed query execution engine.",
        ],
      },
      {
        ...
        textColor: "text-blue-500",
        items: [
          "Role-Based Access Control (RBAC) & Authentication – Secure database access with LDAP, OIDC, and certificate-based authentication.",
          "SSL/TLS Encryption & Data Masking – Ensure end-to-end encryption for data in transit and at rest.",
          "Audit Logging & Compliance Readiness – Meet SOC 2, HIPAA, GDPR, and PCI-DSS requirements.",
        ],
      },
      {
        ...
        textColor: "text-blue-500",
        items: [
          "CockroachDB Serverless for Cloud-Native Applications – Enable automated scaling and pay-per-use database consumption.",
          "Event-Driven Architectures & Streaming Data – Integrate with Kafka, RabbitMQ, and real-time analytics pipelines.",
          "Time-Series & IoT Data Processing – Store and analyze high-velocity time-series data with minimal latency.",
        ],
      },
      {
        image: "/images/icon-7.png",
        title: "Managed CockroachDB Services & Enterprise Support",
        textColor: "text-blue-500",
        items: [
          "24/7 Monitoring & Incident Response – Real-time database monitoring and proactive issue resolution.",
          "Automated Upgrades & Patch Management – Ensure CockroachDB remains secure and up-to-date.",
    ...
    workloads: [
      {
        ...
        description:
          "High-performance database for fintech, SaaS, and enterprise applications.",
      },
      {
        title: "Distributed Cloud-Native Applications",
        description: "Scalable, geo-distributed database for microservices.",
      },
      {
        title: "E-Commerce & Retail",
        description:
          "Power product catalogs, inventory management, and personalized recommendations.",
      },
      {
        title: "Financial Services & Payment Processing",
        description:
          "Support for low-latency, ACID-compliant global transactions.",
      },
      {
        title: "AI/ML & Data Science Pipelines",
        description: "Enable feature stores and real-time ML model inference.",
      },
      {
        title: "Multi-Tenant SaaS Applications",
        description:
          "Securely scale multi-region software platforms with built-in tenant isolation.",
      },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      <Head>
        <title>Mahity - CockroachDB Services</title>
        <meta
          name="description"
          content="Mahity CockroachDB Database Services"
        />
