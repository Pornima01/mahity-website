...
export default function Home() {
  ...
  const workloads = [
    ...
    "Virtualized Databases & Stateful Applications",
    "AI/ML & High-Performance Computing (HPC)",
    "Development & Testing Environments",
    "Regulated & Compliance-Critical Workloads",
  ];
  ...
  const blogData = [
    {
      ...
      description:
        "Run traditional VM workloads on Kubernetes without refactoring applications.",
    },
    {
      image: "/images/Blog-3.png",
      title: "Dev/Test Environments on Demand",
      description:
        "Spin up virtualized test environments with Kubernetes automation.",
    },
    {
      image: "/images/Blog-2.png",
      title: "Live Migration & Disaster Recovery",
      description: "Migrate VMs dynamically and ensure business continuity.",
    },
  ];

  // Services data
  const services = [
    { name: "Serverless / Event-Driven", icon: "/images/Group 512.png", link:"/kubernetes/serverless-event-driven"},
    { name: "Container Orchestration", icon: "/images/Vector-1.png", link:"/kubernetes/container-orchestration"},
    { name: "Service Mesh", icon: "/images/Vector-1.png", link:"/kubernetes/service-mesh"},
    { name: "Machine Learning & AI", icon: "/images/Vector-1.png", link:"/kubernetes/machine-learning-ai"},
  ];

  const serviceData = [
    {
      title: " Live Migration & High Availability",
      ...
      features: [
        {
          ...
          description:
            "Move running VMs between nodes without service disruption.",
        },
        {
          icon: "⚡",
          title: "Automated Failover & Recovery",
          description:
            "Ensure high availability with self-healing VMs and node failover strategies.",
        },
        {
          icon: "📡",
          title: "Cross-Cluster VM Replication",
          description:
            "Improve redundancy with VM replication across multiple Kubernetes clusters.",
        },
      ],
    },
    {
      title: "Security, Compliance & Policy Enforcement",
      icon: "/images/icon-3.png",
      bgColor: "bg-[#037CFF] text-white",
      features: [
        {
          icon: "🔑",
          title: "Role-Based Access Control (RBAC) & Identity Management",
          description: "Define user and service permissions for VM access.",
        },
        {
          icon: "🛡",
          title: "Encrypted Storage & Secure Boot",
          description:
            "Protect VM images, disks, and data at rest and in transit.",
        },
        {
          icon: "📜",
          title: "Compliance & Governance Auditing ",
          description:
            "Enforce security policies and generate compliance reports for regulatory requirements.",
        },
      ],
    },
    {
      title: "Networking & Storage Virtualization",
      icon: "/images/Group-5.png",
      bgColor: "bg-white hover:bg-[#037CFF]",
      features: [
        {
          icon: "📡",
          title: "Software-Defined Networking (SDN) for VMs",
          description:
            "Enable dynamic IP addressing, network isolation, and virtualized network functions.",
        },
        {
          icon: "🔗",
          title: "Multi-Networking Support",
          description:
            "Connect VMs to multiple networks with policy-driven access control.",
        },
        {
          icon: "💾",
          title: "Persistent & Ephemeral Storage Options",
          description:
            "Attach block, file, or object storage dynamically to VMs.",
        },
      ],
    },
    {
      title: "Observability, Monitoring & Performance Optimization",
      ...
      features: [
        {
          ...
          description:
            "Gain insights into CPU, memory, disk, and network utilization.",
        },
        {
          icon: "🔍",
          title: "Logging & Tracing for VM Workloads",
          description:
            "Integrate centralized logging and distributed tracing for troubleshooting.",
        },
        {
          icon: "🚀",
          title: "Predictive Resource Allocation",
          description:
            "Optimize VM placement and resource utilization with AI-driven scheduling.",
        },
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      <Head>
        <title>Kubernetes Virtualization</title>
        <meta
          name="description"
          content="Enterprise-grade Kubernetes Virtualization"
        />
      </Head>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-8 text-sm md:text-base">
              Our virtualization solutions for Kubernetes enable organizations
              to modernize their infrastructure by running virtual machines
              (VMs) alongside containers on a unified platform. By leveraging
              open-source technologies, we provide automated VM lifecycle
              management, high availability, multi-cloud orchestration, and
              security policies to ensure a seamless transition from traditional
              virtualization to a cloud-native environment.
            </p>
          </div>
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          {[
            {
              title: "Automated VM Lifecycle Management",
              description:
                "Provision, scale, and manage virtual machines using Kubernetes-native automation.",
              link: "/learn-more-automation",
              image: "/images/Group.png",
            },
            {
              title: "Policy-Based Security & Access Control",
              description:
                "Implement fine-grained security policies, role-based access control (RBAC), and encryption.",
            ...
            },
            {
              ...
              description:
                "Gain real-time visibility into VMs with integrated logging, tracing, and performance analytics.",
