...
export default function Home() {
  ...
  const blogData = [
    ...
    },
    {
      ...
      title: "AI-Enhanced Healthcare & Medical Imaging",
      description: "Deploy AI models for diagnostics and patient analytics.",
    },
  ];
  ...
  const services = [
    ...
    { name: "Virtualization", icon: "/images/Vector-1.png", link:"/kubernetes/virtualization" },
  ];

  const serviceData = [
    {
      title: "Observability, Monitoring & Cost Optimization",
      ...
      features: [
        {
          ...
          description:
            "Gain real-time insights into training and inference workloads.",
        },
        {
          icon: "🔍 ",
          title: "Resource Usage & Cost Analytics",
          description:
            "Optimize compute costs by preventing under/over-utilization.",
        },
        {
          icon: "🚀",
          title: "Predictive Scaling & Anomaly Detection",
          description: "Automate AI workload scaling based on usage trends.",
        },
      ],
    },
    {
      title: "AI Model Serving & Real-Time Inference",
      icon: "/images/Group-6.png",
      bgColor: "bg-[#037CFF] text-white",
      features: [
        {
          icon: "⚡",
          title: "High-Performance AI Model Deployment",
          description:
            "Serve AI models at scale with autoscaling and load balancing.",
        },
        {
          icon: "🔗",
          title: "Multi-Version Model Management",
          description: "Manage different versions of AI models seamlessly.",
        },
        {
          icon: "🔄",
          title: "Auto-Retraining & Continuous Learning Pipelines",
          description:
            "Automate model updates based on real-time data feedback.",
        },
      ],
    },
    {
      title: " AI/ML Model Training & Distributed Computing",
      ...
      features: [
        {
          ...
          description:
            "Parallelize AI model training across multiple nodes for faster results.",
        },
        {
          icon: "🔀",
          title: "Multi-Node Scheduling & Auto-Scaling",
          description:
            "Optimize computing resources dynamically based on workload needs.",
        },
        {
          icon: "🎯",
          title: "Custom Workload Placement Strategies",
          description:
            "Allocate compute resources intelligently to minimize latency and cost.",
        },
      ],
    },
    {
      title: "Intelligent Resource Orchestration & GPU Scheduling",
      icon: "/images/Group-4.png",
      bgColor: "bg-white hover:bg-[#037CFF] hover:text-white",
      features: [
        {
          icon: "🚀",
          title: "Dynamic GPU/TPU Allocation",
          description:
            "Automatically allocate GPUs/TPUs to AI workloads based on demand.",
        },
        {
          icon: "🌎",
          title: "Multi-Tenant AI Workload Isolation",
          description:
            "Securely isolate AI jobs across different teams and users.",
        },
        {
          icon: "📦 ",
          title: "Optimized Cluster Resource Management",
          description:
            "Balance ML workloads to prevent resource starvation or waste.",
        },
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      <Head>
        <title>Kubernetes Machine Learning and AI</title>
        <meta
          name="description"
          content="Enterprise-grade Kubernetes Machine Learning and AI"
        />
      </Head>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-8 text-sm md:text-base">
              Our AI & Machine Learning solutions on Kubernetes enable
              organizations to deploy, orchestrate, and scale ML workloads
              efficiently. We provide automated workload scheduling, GPU
              acceleration, optimized resource allocation, distributed training,
              and intelligent scaling to streamline AI/ML operations on any
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          {[
            {
              title: "Efficient GPU/TPU Acceleration & Resource Scheduling",
              description:
            ...
            {
              title: "Policy-Based Scheduling & Fair Resource Allocation",
              description:
            ...
            {
              title: "Automated Model Deployment & CI/CD Integration",
              description:
