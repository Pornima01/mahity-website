...
export default function Home() {
  ...
  const workloads = [
    ...
    "Regulated & Security-First Workloads",
  ];
  ...
  const blogData = [
    {
      ...
      title: "Multi-Cloud & Hybrid Kubernetes Management",
      description:
        "Manage Kubernetes clusters across multiple cloud providers and on-premise data centers",
    },
    {
      image: "/images/Blog-2.png",
      title: "Application Modernization & Microservices Adoption",
      description:
        "Transition from monolithic applications to scalable microservices",
    },
    {
      image: "/images/Blog-3.png",
      title: "Secure Multi-Cluster Networking",
      description:
        "Enable seamless communication between Kubernetes clusters across different regions",
    },
  ];
  ...
  const serviceData = [
    {
      ...
      features: [
        {
          icon: "⚡",
          title: "Automated Cluster Provisioning",
          description:
            "Deploy Kubernetes clusters with built-in automation and best practices.",
        },
        {
          icon: "🔄",
          title: "Seamless Cluster Lifecycle Management",
          description: "Automate upgrades, patching, and decommissioning.",
        },
        {
          icon: "📦",
          title: "Application & Workload Orchestration",
          description:
            "Deploy microservices, batch workloads, and AI/ML pipelines efficiently.",
        },
      ],
    },
    {
      title: "Secure Multi-Cluster Networking & Connectivity",
      icon: "/images/icon-2.png",
      bgColor: "bg-[#037CFF] text-white",
      features: [
        {
          icon: "🔗",
          title: "Encrypted Cross – Cluster Communication",
          description:
            "Establish secure, policy-based connections between distributed Kubernetes clusters.",
        },
        {
          icon: "🌎",
          title: "Multi – Cluster Service Discovery & Load Balancing",
          description:
            "Optimize service-to-service communication across clusters.",
        },
        {
          icon: "🛠️",
          title: "Traffic Routing & Failover",
          description:
            "Implement intelligent traffic routing for high availability and disaster recovery.",
        },
      ],
    },
    {
      ...
      features: [
        {
          icon: "📜",
          title: "Policy – Based Security Enforcement",
          description:
            "Automate compliance checks, security policies, and workload protection.",
        },
        {
          icon: "🔍",
          title: "Security Auditing & Threat Detection",
          description:
            "Continuously monitor clusters for vulnerabilities and misconfigurations.",
        },
        {
          icon: "🛡️",
          title: "Zero Trust & Access Control",
          description:
            "Implement strict authentication, authorization, and workload isolation policies.",
        },
      ],
    },
    {
      title: "Backup, Disaster Recovery & Data Management",
      ...
      features: [
        {
          ...
          description:
            "Schedule and manage persistent volume and workload backups.",
        },
        {
          icon: "♻",
          title: "Disaster Recovery & Failover",
          description:
            "Restore clusters and applications quickly in case of failure.",
        },
        {
          icon: "📦",
          title: "Persistent Storage Solutions",
          description:
            "Enable scalable and distributed storage for stateful applications.",
        },
      ],
    },
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-6 md:px-12 lg:px-20 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          {[
            {
              title: "Automated Kubernetes Cluster Lifecycle",
              description:
            ...
            {
              title: "Multi-Cloud & Hybrid Deployments",
              description:
