      ...
      <section className="relative bg-white min-h-[70vh] py-12 px-6 md:px-12 flex flex-col justify-center items-center overflow-hidden">
        ...
        <div className="max-w-2xl text-center relative z-10 px-4 md:px-0">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-10">
            Google HPC (High-Performance Computing) Migration Service
          </h2>
          <p className="text-gray-700 text-lg md:text-xl">
            As a trusted Google Cloud Partner, we provide end-to-end
            High-Performance Computing (HPC) migration services to help
            organizations move their intensive workloads to Google Cloud
            Platform (GCP). Our experts handle everything from architecture
            design to performance tuning, ensuring maximum scalability, speed,
            and cost efficiency for compute-heavy applications.{" "}
          </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">
                  HPC Assessment & Migration Strategy
                </h3>
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>✔ Workload analysis & performance benchmarking</li>
                  <li>
                    ✔ Migration strategy selection – Lift & shift,
                    re-platforming, or modernization
                  </li>
                  <li>✔ Cost & performance optimization planning</li>
                </ul>
              </div>
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">
                  HPC Storage & Data Management
                </h3>
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>
                    ✔ High-speed storage solutions – Filestore, Persistent Disk,
                    and Cloud Storage
                  </li>
                  <li>
                    ✔ Optimized data transfer – Parallel file systems, Transfer
                    Appliance, and Cloud Storage FUSE
                  </li>
                  <li>✔ Hybrid & multi-cloud storage strategies</li>
                </ul>
              </div>
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">
                  Performance Acceleration & Optimization
                </h3>
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>
                    ✔ Accelerated computing with GPUs, TPUs & high-performance
                    CPUs
                  </li>
                  <li>✔ Auto-scaling clusters for on-demand computing power</li>
                  <li>
                    ✔ Network optimization with Cloud Interconnect & low-latency
                    networking
                  </li>
                </ul>
              </div>
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>
                    ✔ End-to-end encryption & secure access controls (IAM, VPC
                    Service Controls)
                  </li>
                  <li>✔ HPC workload monitoring & anomaly detection</li>
                  <li>
                    ✔ Compliance adherence – HIPAA, GDPR, FedRAMP, ISO 27001
                  </li>
                </ul>
              </div>
            </div>
...
export default googleHPCmigration;
