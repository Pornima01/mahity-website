      ...
      <section className="relative bg-white min-h-[70vh] py-12 px-6 md:px-12 flex flex-col justify-center items-center overflow-hidden">
        ...
        <div className="max-w-2xl text-center relative z-10 px-4 md:px-0">
          ...
          <p className="text-gray-700 text-lg md:text-xl">
            As a trusted Google Cloud Partner, we help businesses take control
            of their Google Cloud costs with proactive cost management,
            budgeting, and resource optimization strategies. Our experts provide
            real-time visibility, automation, and strategic recommendations to
            ensure you get the best performance at the lowest cost without
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>
                    ✔ Real-time cost tracking & dashboards with Cloud Billing
                  </li>
                  <li>✔ Budget alerts & spending anomaly detection</li>
                  <li>✔ Policy-based cost governance & chargeback models</li>
                </ul>
              </div>
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>✔ Reserved instances & Committed Use Discounts (CUDs)</li>
                  <li>✔ Sustained Usage Discounts & custom pricing models</li>
                  <li>✔ Spot VM & preemptible instance recommendations</li>
                </ul>
              </div>
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>
                    ✔ Resource rightsizing – Optimizing VM, storage, and
                    database sizes
                  </li>
                  <li>✔ Identifying & eliminating unused/idle resources</li>
                  <li>
                    ✔ Storage tiering & cost-efficient data lifecycle policies
                  </li>
                </ul>
              </div>
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>
                    ✔ Autoscaling & serverless adoption (Cloud Run, GKE, Cloud
                    Functions)
                  </li>
                  <li>
                    ✔ AI-powered cost-saving recommendations via Recommender API
                  </li>
                  <li>
                    ✔ Infrastructure as Code (IaC) for cost-efficient
                    provisioning
                  </li>
                </ul>
              </div>
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">
                  FinOps & Billing Advisory
                </h3>
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>
                    ✔ Cost allocation & chargeback models for teams/projects
                  </li>
                  <li>
                    ✔ Cloud billing structure optimization & invoice analysis
                  </li>
                  <li>✔ Forecasting & trend analysis for budget planning</li>
                </ul>
              </div>
            </div>
          </div>
...
export default GoogleCostManagement;
