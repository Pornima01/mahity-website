...
const googleApplicationMigration = () => {
  return (
    <>
      <section className="relative bg-white min-h-[70vh] py-12 px-6 md:px-12 flex flex-col justify-center items-center overflow-hidden">
        ...
        <div className="max-w-2xl text-center relative z-10 px-4 md:px-0">
          ...
          <p className="text-gray-700 text-lg md:text-xl">
            As a trusted Google Cloud Partner, we provide end-to-end application
            migration services to help businesses move their workloads to Google
            Cloud Platform (GCP) with minimal disruption. Our experts assess,
            strategize, and execute application migrations—whether it&apos;s
            lift &amp; shift, re-platforming, or full cloud-native
            transformation—ensuring performance, security, and cost efficiency.{" "}
          </p>
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left -mt-14">
            ...
            <div className="space-y-4 w-full max-w-md mt-4">
              ...
              <Card className="flex items-center p-4 border border-gray-200 shadow-md w-full">
                ...
                <CardContent className="p-0">
                  End-to-End Cloud Adoption Strategy
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>✔ Current environment analysis & architecture review</li>
                  <li>
                    ✔ Migration strategy selection – Lift & shift,
                    re-platforming, refactoring, or rebuilding
                  </li>
                  <li>✔ Dependency mapping & risk assessment</li>
                </ul>
              </div>
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <h3 className="text-lg font-semibold mb-2 text-gray-800">
                  Fully Managed Application Migration
                </h3>
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>
                    ✔ Virtual Machine (VM) migrations with Google’s Application
                    Migration Service
                  </li>
                  <li>
                    ✔ Containerization of applications with GKE & Cloud Run
                  </li>
                  <li>
                    ✔ Re-platforming legacy applications to cloud-native
                    solutions Spot VM & preemptible instance recommendations
                  </li>
                </ul>
              </div>
              ...
              <div className="group bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg hover:border-blue-400 transition transform hover:-translate-y-2 cursor-pointer text-left">
                ...
                <ul className="text-gray-600 text-sm space-y-2">
                  <li>
                    ✔ Refactoring applications for Kubernetes, serverless &
                    microservices
                  </li>
                  <li>
                    ✔ Integrating DevOps & CI/CD pipelines for automated
                    deployment
                  </li>
                  <li>✔ Performance tuning & auto-scaling configurations</li>
                </ul>
              </div>
            </div>
          </div>
...
export default googleApplicationMigration;
