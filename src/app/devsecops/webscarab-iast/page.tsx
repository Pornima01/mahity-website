...
const services = [
  {
    title: "WebScarab Deployment & Configuration",
    details: [
  ...
  {
    title: "Web Traffic Analysis & Security Insights",
    details: [
...
const propositions = [
  {
    id: 1,
    title: "Real-Time Security Testing (IAST) ",
    description:
  ...
  {
    id: 4,
    title: "Seamless CI/CD & DevSecOps Integration",
    description: "Automate security checks within DevOps pipelines.",
    icon: "/images/Group (1).png",
  },
];
      ...
      <section className="container mx-auto px-4 py-12 md:py-16 flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 lg:w-5/12 mb-8 md:mb-0 px-4 md:px-6 lg:px-14 lg:pr-8 relative z-10">
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-6 md:mb-10 md:-mt-8">
            Our WebScarab Services provide enterprises with Interactive
            Application Security Testing (IAST) to detect real-time
            vulnerabilities in web applications during runtime. As an
            open-source software support provider, we help organizations deploy,
            integrate, and optimize WebScarab for in-depth security assessments,
            vulnerability detection, and DevSecOps automation.
          </p>
          <button
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            <div className="pt-0 sm:pt-8 md:pt-16 lg:pt-36 bg-opacity-80 rounded-lg mb-8 lg:mb-0 lg:max-w-xl">
              ...
              <p className="text-gray-600">
                ...
                organizations integrate, optimize, and manage WebScarab (IAST) for real-time
