...
const services = [
  {
    title: "SonarQube Deployment & Configuration",
    details: [
  ...
  {
    title: "DevSecOps Integration & Automation",
    details: [
...
const propositions = [
  ...
  {
    id: 2,
    title: "CI/CD Integration for DevSecOps",
    description:
  ...
  {
    id: 4,
    title: "OWASP, CWE, and Compliance Scanning",
    description:
      ...
      <section className="container mx-auto px-4 py-12 md:py-16 flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 lg:w-5/12 mb-8 md:mb-0 px-4 md:px-6 lg:px-14 lg:pr-8 relative z-10">
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-6 md:mb-10 md:-mt-8">
            Our SonarQube Services provide enterprises with comprehensive Static
            Application Security Testing (SAST) and code quality analysis to
            ensure secure, reliable, and maintainable code. As an open-source
            software support provider, we help organizations deploy, optimize,
            and integrate SonarQube into their DevSecOps pipelines, enabling
            continuous security, compliance, and technical debt management.
          </p>
          <button
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            <div className="pt-0 sm:pt-8 md:pt-16 lg:pt-36 bg-opacity-80 rounded-lg mb-8 lg:mb-0 lg:max-w-xl">
              ...
              <p className="text-gray-600">
                ...
                organizations integrate, optimize, and manage Sonarqube (SAST) for real-time
