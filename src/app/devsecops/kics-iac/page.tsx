...
const services = [
  {
    title: "KICS Deployment & Configuration",
    details: [
  ...
  {
    title: "Infrastructure as Code (IaC) Security & Compliance",
    details: [
...
const propositions = [
  {
    id: 1,
    title: "Automated IaC Security Scanning",
    description:
  ...
  {
    id: 2,
    title: "Shift-Left Security for DevOps",
    description:
  ...
  {
    id: 4,
    title: "Multi-Cloud Compliance Enforcement",
    description:
      ...
      <section className="container mx-auto px-4 py-12 md:py-16 flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 lg:w-5/12 mb-8 md:mb-0 px-4 md:px-6 lg:px-14 lg:pr-8 relative z-10">
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-6 md:mb-10 md:-mt-8">
            Our KICS (Keeping Infrastructure as Code Secure) Services help
            organizations detect misconfigurations, security vulnerabilities,
            and compliance risks in Infrastructure as Code (IaC) templates. As
            an open-source software support provider, we specialize in
            deploying, integrating, and optimizing KICS for proactive cloud
            security posture management and DevSecOps automation.
          </p>
          <button
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            <div className="pt-0 sm:pt-8 md:pt-16 lg:pt-36 bg-opacity-80 rounded-lg mb-8 lg:mb-0 lg:max-w-xl">
              ...
              <p className="text-gray-600">
                ...
                organizations integrate, optimize, and manage KICS (IAC) for real-time
