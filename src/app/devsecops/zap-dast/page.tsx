...
const services = [
  {
    title: "ZAP Deployment & Configuration",
    details: [
  ...
  {
    title: "Automated & Manual Dynamic Application Security Testing (DAST)",
    details: [
  ...
  {
    title: "CI/CD Pipeline Integration for DevSecOps",
    details: [
  ...
  {
    title: "Security Hardening & Compliance Validation",
    details: [
...
const propositions = [
  {
    id: 1,
    title: "Automated Kubernetes Cluster Lifecycle Management",
    description:
      ...
      <section className="container mx-auto px-4 py-12 md:py-16 flex flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2 lg:w-5/12 mb-8 md:mb-0 px-4 md:px-6 lg:px-14 lg:pr-8 relative z-10">
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-6 md:mb-10 md:-mt-8">
            Our ZAP (DAST) Security Testing Services provide enterprises with
            continuous, automated, and in-depth web application security testing
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            <div className="pt-0 sm:pt-8 md:pt-16 lg:pt-36 bg-opacity-80 rounded-lg mb-8 lg:mb-0 lg:max-w-xl">
              ...
              <p className="text-gray-600">
                ...
                organizations integrate, optimize, and manage ZAP for real-time
