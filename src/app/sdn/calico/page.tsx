...
export default function Home() {
  ...
  const workloads = [
    ...
    "Regulated & Security-Sensitive Industries",
    "Microservices & Service Mesh Replacements",
  ];

  const services = [
    {
      title: "Calico Deployment & Configuration",
      details: [
        "Enterprise-Ready Calico Deployment – Install and configure Calico Open Source or Calico Enterprise.",
        "Calico CNI Implementation – Replace existing CNIs like Flannel, Weave, or Cilium with Calico’s high-performance networking.",
        "Integration with Kubernetes & OpenShift – Ensure Calico is fully optimized for containerized workloads.",
      ],
    ...
    {
      title: "Advanced Network Security & Policy Enforcement",
      desc: "Identity-Based Network Policies – Implement policies based on Kubernetes identities.",
      details: [
        "Zero-Trust Microsegmentation – Implement Kubernetes-native network policies for workload isolation.",
        "Security Hardening & Compliance – Meet regulatory standards like PCI-DSS, HIPAA, and GDPR.",
        "DDoS Protection & Threat Mitigation – Reduce attack surfaces with Calico’s network security features.",
      ],
    ...
    {
      title: "Enterprise-Grade Support & Managed Services",
      desc: "Enable real-time network visibility and troubleshooting with Hubble.",
      details: [
        "24/7 Monitoring & Incident Response – Ensure high availability and quick resolution of network issues.",
        "Custom Policy Design & Enforcement – Develop and implement security policies tailored to business needs.",
        "Ongoing Maintenance & Version Upgrades – Keep Calico deployments updated, secure, and optimized.",
      ],
    ...
    {
      title: "Migration & Hybrid Cloud Networking",
      desc: "Optimized network latency & throughput with BPF-based packet processing.",
      details: [
        "Migration from Existing CNIs – Seamlessly migrate from Flannel, Weave, or Cilium to Calico.",
        "Hybrid Cloud & Multi-Cloud Networking – Connect workloads across AWS, Azure, GCP, and on-premise environments.",
        "Calico for OpenShift – Deploy and optimize Calico with OpenShift SDN for enhanced security.",
      ],
  ...
  return (
    <div>
      <Head>
        <title>Calico Services</title>
        <meta
          name="description"
          content="Mahity's Calico Services provide enterprises with advanced networking, security, and observability for Kubernetes and cloud-native environments"
        />
        ...
        <section className="container mx-auto px-4 py-12 md:py-16 flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 lg:w-5/12 mb-8 md:mb-0 px-4 md:px-6 lg:px-14 lg:pr-8 relative z-10">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-6 md:mb-8 md:-mt-8">
              Our Calico Services provide enterprises with a powerful, scalable,
              and secure networking and security solution for Kubernetes,
              OpenShift, and cloud-native environments. As an open-source
              software support provider, we help organizations deploy, optimize,
              and secure Calico-powered networks, ensuring high-performance
              networking, security, and observability across hybrid and
