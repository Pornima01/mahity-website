        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-center w-full max-w-5xl mt-10 gap-10">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center">
            <p className="mt-4 text-gray-600 max-w-lg">
              Empower your workforce and educational institutions with Microsoft
              Learning Pathways and Microsoft Viva, two powerful platforms
              designed to enhance learning, engagement, and productivity. Our
              services help organizations of all sizes integrate these solutions
              seamlessly to drive employee and student success.
            </p>
            ...
            <ul className="space-y-6 text-gray-700">
              <li className="flex items-center space-x-3">
                <Image
                  ...
                  className="w-6 h-6"
                />
                <span>Customized Learning & Development (L&D) Strategy</span>
              </li>
              <li className="flex items-center space-x-3">
                <Image
                  ...
                  className="w-6 h-6"
                />
                <span>Employee & Student Engagement</span>
              </li>
              <li className="flex items-center space-x-3">
                <Image
            ...
            <ul className="space-y-4 text-gray-700">
              <li className="flex items-center space-x-2 justify-center lg:justify-start">
                ...
                <div>
                  ...
                  <p className="text-xs">
                    Set up Microsoft Learning Pathways within your Microsoft 365
                    environment.
                  </p>
                </div>
              </li>
              <li className="flex items-center space-x-2 justify-center lg:justify-start">
                ...
                />
                <div>
                  <span className="font-bold">Customized Learning Portal</span>
                  <p className="text-xs">
                    Brand and tailor the learning experience to your
              ...
              <li className="flex items-center space-x-2 justify-center lg:justify-start">
                ...
                />
                <div>
                  <span className="font-bold">Curated Training Content</span>
                  <p className="text-xs">
                    Provide access to Microsoft-curated training modules and
                    custom content.
                  </p>
                </div>
              </li>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Use AI to organize and deliver knowledge across teams.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-gray-900 font-semibold">
                  Integration with LMS & HR Platforms
                </h3>
                <p className="text-gray-600 text-sm">
                  Connect Viva with existing Learning Management Systems (LMS)
                  for seamless learning delivery.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Ensure a smooth transition with hands-on training and support.
                </p>
              </div>
            </div>
      ...
      >
        <div className="container mx-auto px-4 md:px-8">
          <h2 className="text-5xl font-medium text-gray-700 mb-6 text-center ">
            Microsoft Learning Pathways Use Cases{" "}
          </h2>
          <p className="text-lg text-gray-600 mb-32 text-center">
            Microsoft Viva is an employee experience platform that enhances
            communication, well- being, learning, and insights within Microsoft
            365.{" "}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border-2 border-gray-200 rounded p-6 transition-transform duration-500 hover:scale-105">
              ...
              <p className="text-gray-600 mb-6">
                Foster a connected workforce with interactive communities.
              </p>
            ...
            <div className="border-2 border-gray-200 rounded p-6 transition-transform duration-500 hover:scale-105">
              ...
              <p className="text-gray-600 mb-6">
                Deliver tailored training based on employee roles and interests.
              </p>
            ...
            <div className="border-2 border-gray-200 rounded p-6 transition-transform duration-500 hover:scale-105">
              ...
              <p className="text-gray-600 mb-6">
                Connect with LinkedIn Learning, Microsoft Learn, and third-party
                providers.
              </p>
            ...
            <div className="border-2 border-gray-200 rounded p-6 transition-transform duration-500 hover:scale-105">
              ...
              <p className="text-gray-600 mb-6">
                upskill employees with ongoing education in Microsoft
                technologies
              </p>
