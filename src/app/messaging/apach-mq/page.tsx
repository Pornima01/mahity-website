...
const KEY_SERVICES: KeyService[] = [
  {
    ...
    text: "Enterprise-Grade Message Brokering",
  },
  {
    image: "/images/Group 470.png",
    text: "Hybrid & Multi-Cloud Deployments",
  },
  {
...
const SERVICE_OFFERINGS: ServiceOffering[] = [
  {
    ...
    items: [
      "ActiveMQ & Artemis Cluster Setup – Deploy Apache ActiveMQ in standalone or clustered modes.",
      "Hybrid & Multi-Cloud Deployments – Set up ActiveMQ in AWS, Azure, GCP, Kubernetes, OpenShift, or on-prem.",
      "Broker Configuration & Optimization – Fine-tune message queues, topics, memory limits, and network connectors.",
    ],
  },
  {
    image: "/images/Group (1).png",
    title: "ActiveMQ Security & Access Control",
    items: [
      "Authentication & Authorization – Implement LDAP, Kerberos, OAuth, and JAAS-based authentication.",
      "Role-Based Access Controls (RBAC) & ACLs – Configure granular permissions for message producers and consumers.",
      "End-to-End Encryption – Secure messaging with TLS/SSL encryption and message-level security.",
    ],
  },
  {
    ...
    items: [
      "Clustering & Load Balancing – Implement ActiveMQ clustering, shared store, and network connectors.",
      "Failover & Disaster Recovery – Deploy replicated message stores and backup strategies.",
      "Latency & Throughput Optimization – Tune persistence adapters, prefetch policies, and message dispatching.",
    ],
  },
  {
    ...
    items: [
      "Real-Time Metrics & Dashboards – Integrate with Prometheus, Grafana, ELK Stack, and OpenTelemetry.",
      "Event Logging & Distributed Tracing – Enable structured logging for debugging and troubleshooting.",
      "Alerting & Incident Response – Set up custom alerts for broker failures, queue saturation, and message backlog.",
    ],
  },
  {
    image: "/images/Vector (3).png",
    title: "Messaging Integration & Application Connectivity",
    items: [
      "Enterprise Application Integration (EAI) – Connect ActiveMQ with ERP, CRM, and legacy systems.",
      "Microservices & Event-Driven Architecture – Implement ActiveMQ as a message bus for microservices.",
      "Kafka & Streaming Integration – Enable event-driven workflows with Kafka and ActiveMQ interoperability.",
    ],
  },
  {
    image: "/images/Vector (2).png",
    title: "Managed ActiveMQ Services & Enterprise Support",
    items: [
      "24/7 Monitoring & SLA-Backed Support – Ensure high availability with proactive monitoring and troubleshooting.",
      "Automated Upgrades & Patch Management – Keep ActiveMQ secure and up-to-date.",
      "Disaster Recovery & Backup Solutions – Implement persistent message storage, replication, and failover.",
    ],
  },
];
...
const COMPANY_DESCRIPTION: string =
  "Our Apache ActiveMQ Services enable organizations to build scalable, high-performance, and secure messaging solutions for real-time applications. As an open-source software support provider, we specialize in deploying, configuring, optimizing, and managing Apache ActiveMQ and ActiveMQ Artemis for businesses that require robust message brokering, reliable event-driven communication, and seamless application integration";

export default function Home() {
  return (
    <div className="bg-white min-h-screen">
      <Head>
        <title>Apache MQ - API Management & Streaming</title>
        <meta
          name="description"
          content="Apache MQ API Management and Streaming Services"
        />
