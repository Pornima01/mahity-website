            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="border-2 border-gray-200 rounded-lg p-6 transition-transform duration-500 hover:scale-105">
                ...
                <p className="text-gray-600 mb-6">
                  From initial setup to deployment, we handle everything
                </p>
              </div>
              ...
              <div className="border-2 border-gray-200 rounded p-6 transition-transform duration-500 hover:scale-105">
                ...
                <p className="text-gray-600 mb-6">
                  Works flawlessly with Google Sheets, BigQuery, and more
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    description:
                      "Interactive, real-time dashboards for actionable insights",
                  },
                  {
                    title: "📤 Automated Report Scheduling",
                    description: "Deliver insights via email or PDF exports",
                  },
                  {
                    title: "🔗 Data Source Integration",
                    description:
                      "Connects seamlessly with Google Sheets, BigQuery, SQL databases, and APIs",
                  },
                ].map((service, index) => (
                  <div key={index}>
                ...
                {[
                  {
                    ...
                    description: "Tailor-made charts, graphs, and KPI tracking",
                  },
                  {
                    title: "⚡ Performance Optimization",
                    description: "Faster queries and optimized data processing",
                  },
                ].map((service, index) => (
                  <div key={index}>
                    <div className="flex items-center mb-2">
            ...
            {[
              {
                ...
                description:
                  "Sales, marketing, finance, and operational analytics",
              },
              {
                title: "Field Data Collection",
                description:
                  "Mobile-friendly solutions for surveys, inspections, and audits",
              },
              {
                title: "Business Process Automation",
                description:
                  "Workflow automation, approvals, and task management",
              },
              {
                title: "Customer Relationship Management (CRM)",
                description:
                  "Streamlined client interactions and sales tracking",
              },
              {
                title: "Inventory & Asset Management",
                description: "Track and manage business resources efficiently",
              },
            ].map((workload, index) => (
              <div
                key={index}
